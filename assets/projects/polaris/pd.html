...
<h3 style="text-align: center;" id="bottom-nav"><a href="software.html"><-- Software: Planning Musical AR Instruments</a></h3>
...
<div id="text" class="text">
    ...
    <p>
        <div class="youtube-video"><iframe onload="document.getElementById('media_object').style.opacity='1'" src="https://www.youtube.com/embed/CzJlEEcOt-A" frameborder="0" height="300" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
    </p>
   
    <h4>Finger Reactive (10x synth gens) AR Synthesiser</h4>
    <p>
        <div class="youtube-video"><iframe onload="document.getElementById('media_object').style.opacity='1'" src="https://www.youtube.com/embed/dJUd0186NbA" frameborder="0" height="300" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
    </p>

    <h4>Palm Reactive (2x synth gens) AR Synthesiser</h4>
    <p>
        <div class="youtube-video"><iframe onload="document.getElementById('media_object').style.opacity='1'" src="https://www.youtube.com/embed/miQI4jetETs" frameborder="0" height="300" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
    </p>
