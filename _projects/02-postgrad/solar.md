...
<div id="media">
    <div id="media_object">
        <div class="embed-container" id="media_0">
            <img onload="document.getElementById('media_object').style.opacity='1'" style="display: block;" src="solar.jpg" alt="Cellobot"/>
        </div>
    </div>
...
<div class="info">
    <span class="title">SolAR (December, 2018)</span><br />
    
    
</div>

<div id="text" class="text">
    <h3><a href="https://github.com/sambilbow/SolAR/commits/master">file repository</a></h3>
